...
public class Now
{
    ...
    private List<List< Object>> recent_overs;
//    private List<List<Map<Integer, List<String>> >> recent_overs = new ArrayList<List<Map<Integer,List<String>>>>();
    ...
    private List<List< Object>> recent_overs_str;
    ...
    public List<List< Object>> getRecent_overs() {
		return recent_overs;
	}
	public void setRecent_overs(List<List< Object>> recent_overs) {
		this.recent_overs = recent_overs;
	}
	public Break getBreak_() {
		return break_;
	}
	public void setBreak_(Break break_) {
		this.break_ = break_;
	}
    ...
    public List<List< Object>> getRecent_overs_str() {
		return recent_overs_str;
	}
	public void setRecent_overs_str(List<List< Object>>  recent_overs_str) {
