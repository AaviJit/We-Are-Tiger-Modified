...
//
//
//	        return promotionRepository.findAllByBannerSize_Id(bannerSizeId, pageable);
//	}
	...
	@Override
	public Banner findBannerByPageNumberAndPosition(Long pageNUmber, Long position) {
		return bannerRepository.findBannerByPageNumberAndPosition(pageNUmber, position);
	}
