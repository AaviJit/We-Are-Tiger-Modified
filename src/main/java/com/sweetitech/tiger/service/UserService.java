...
public class UserService implements IUserService {
    ...
    public User registerNewUserAccount(final UserDto accountDto) {
        ...
        if (firstNameExist(accountDto.getFirstName())) {
            throw new UserAlreadyExistException("There is an account with this first name: " + accountDto.getEmail());
        }
    ...
    @Override
    public void saveRegisteredUserWithChangedPassword(final User user) {
...
//			}
	...
	@Override
	public Page<User> findAllUserByRoles_Name(String name, int page) {
		PageRequest request =
	            new PageRequest(page, Constants.PAGE_SIZE, Sort.Direction.DESC, "id");
		
		return repository.findAllUserByRoles_Name(name, request);
	}
