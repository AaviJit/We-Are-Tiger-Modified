...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	List<Product> findAllProductByPtag(List<Ptag> ptag);
	
	Page<Product> findAllProductByPtag_Tag(String tag, Pageable pageable);
	Page<Product> findAllProductByNameContaining(String name, Pageable pageable);
	
	Page<Product> findAllProductByGroup_Id(long id, Pageable pageable);
}