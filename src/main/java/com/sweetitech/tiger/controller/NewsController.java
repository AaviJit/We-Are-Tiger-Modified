...
public class NewsController {
	...
	@ResponseBody
	public ResponseEntity<?> createNewNews(@Valid Principal principal,
	...
	@ResponseBody
	public ResponseEntity<?> updateNews(@Valid Principal principal,

			@RequestParam(value = "id", required = true) long id,
										@RequestParam(value = "title", required = false) String title,
			@RequestParam(value = "summary", required = false) String summary, @RequestParam(value = "description", required = false) String description,
			@RequestParam(value = "featruedImageId", required = false) Long featruedImageId,
			@RequestParam(value = "additionalImages", required = false) long[] additionalImages) {
	...
	@ResponseBody
	public ResponseEntity<?> updateNewsWithAdditionaImages(@Valid Principal principal,
		...
		if (hasPrivilege(WRITE_PRIVILEGE, userService.findUserByEmail(principal.getName()))) {
			...
			News nnn = newsService.updateNews(n);
			return new ResponseEntity<News>(nnn, HttpStatus.OK);
		} else {
			return new ResponseEntity<String>("You do not have the permission to do so", HttpStatus.FORBIDDEN);
		}
	...
	public @ResponseBody Page<News> searchNewsByPage(@RequestParam(value = "title", required = true) String title,
